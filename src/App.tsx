  ...
  return (
    <>
      ...
      >
        ...
        {btnArray.map((item) => (
          <button
            ...
            className={`btn btn-${item.type} m-2`}
      ...
      <Alert
        ...
        closeAlert={closeAlertWarning}
        type="warning-subtle"
      />
      <Alert
        show={showAlertSuccess}
        clickDismissable={closeAlertSuccess}
        type="success-subtle"
      />
      <button
        className="btn btn-warning"
        onClick={() => setShowAlertWarning(!showAlertWarning)}
      >
        Warning Alert
      </button>
      <button
        className="btn btn-success ms-2"
        onClick={() => setShowAlertSuccess(!showAlertSuccess)}
      >
        Success Alert
      </button>
    </>
